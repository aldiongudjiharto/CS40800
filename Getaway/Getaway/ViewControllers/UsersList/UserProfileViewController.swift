...
//  Getaway
//
//  Created by Dhriti Chawla on 3/8/19.
...
class UserProfileViewController: UIViewController {
    ...
    @IBOutlet weak var numOfPinsLabel: UILabel!
    @IBOutlet weak var numOfFriendsLabel: UILabel!
    ...
    func fetchUserData() {
        ...
        FirebaseClient().retrieveUserInformationByUID(userID: userUID, completion: { (userDict) in
            ...
            self.friendNameLabel.text = fullName
            ...
            if  bioText != nil && bioText != "" {
                ...
                self.bioLabel.text = ""
                self.bioLabel.backgroundColor = UIColor(white: 1, alpha: 0.01)
            }
